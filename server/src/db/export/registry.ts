...
export const exportModuleRegistry: ExportModuleDefinition[] = [
  {
    ...
    riskLevel: 'low',
    notes: ['Singleton content module. First candidate for a future real export implementation.'],
  },
  {
    ...
    exportStatus: 'skeleton_only',
    riskLevel: 'medium',
    notes: ['Uses company_assets plus shared media_files references; media ownership must be checked before write mode.'],
  },
  {
    ...
    exportStatus: 'skeleton_only',
    riskLevel: 'medium',
    notes: ['Singleton video config with shared media_files references for video/poster metadata.'],
  },
  {
    ...
    exportStatus: 'skeleton_only',
    riskLevel: 'medium',
    notes: ['Fixed slot module; future export must preserve the existing slot JSON shape.'],
  },
  {
    moduleName: 'articles',
  ...
  },
  {
    ...
    riskLevel: 'low',
    notes: ['Current JSON source is expected to be empty in 22-6-2; keep as empty-source confirmation only.'],
  },
];
