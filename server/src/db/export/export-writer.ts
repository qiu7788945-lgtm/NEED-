...
export function buildSkeletonExportPayload(input: {
  ...
  return {
    ...
    note: input.exportStatus === 'skipped_empty_source'
      ? 'This module is treated as empty-source/skipped in the 22-6-3 dry-run export.'
      : 'MySQL-to-JSON export is not implemented for this module in the 22-6-3 dry-run export.',
  };
}
