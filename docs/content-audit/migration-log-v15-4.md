...
2026-04-30 补充纠偏：`family-day` 下 `slug=festo-2025-family-day` 的“费斯托 2025 家庭日”案例组保持为文字型草稿。因真实公开权限和图库素材仍需人工确认，且 `items=[]`，该组 `enabled` 已修正为 `false`，不进入正式静态发布；后续只有在补齐真实素材并确认可公开后，才建议启用。
