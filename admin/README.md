...
4. Choose an upload category and optional ownership fields, then filter or search the list.
5. Keyword search checks file name, original name, alt, description, and caption.
